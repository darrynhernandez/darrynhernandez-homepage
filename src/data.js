...
export const leadership = [
  {
    ...
    description:
      "Translate complex programs into actionable plans teams can execute with confidence.",
  },
  {
    number: "02",
    title: "Team Development",
    description:
      "Build accountable teams and develop individuals into future leaders.",
  },
  {
    number: "03",
    title: "Execution with Ownership",
    description:
      "Drive alignment, accountability, and follow-through across stakeholders and delivery teams.",
  },
];
...
export const insights = [
  ...
  "Building Teams That Own the Outcome",
];
